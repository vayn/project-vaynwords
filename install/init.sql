...
--
ALTER TABLE `vws_des`
  ADD CONSTRAINT `vws_des` FOREIGN KEY (`wid`) REFERENCES `vws_words` (`id`) ON DELETE CASCADE;

--
-- 限制表 `vws_mor`
--
ALTER TABLE `vws_mor`
  ADD CONSTRAINT `vws_mor` FOREIGN KEY (`wid`) REFERENCES `vws_words` (`id`) ON DELETE CASCADE;

--
-- 限制表 `vws_ph`
--
ALTER TABLE `vws_ph`
  ADD CONSTRAINT `vws_ph` FOREIGN KEY (`wid`) REFERENCES `vws_words` (`id`) ON DELETE CASCADE;

--
-- 限制表 `vws_sen`
--
ALTER TABLE `vws_sen`
  ADD CONSTRAINT `vws_sen` FOREIGN KEY (`wid`) REFERENCES `vws_words` (`id`) ON DELETE CASCADE;
